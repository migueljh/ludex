...
Version numbers - Latest versions of any tool, library, or framework
Deprecation status - Whether APIs, functions, or libraries are deprecated
Security advisories - Current CVEs or security recommendations
Best practices - Current recommended patterns (they evolve over time)
Feature availability - When features were introduced in specific versions
How to Verify
...
Reference Files
Codex CLI Reference - Complete command reference and configuration options
Review Prompts Library - Collection of specialized review prompts
Troubleshooting
